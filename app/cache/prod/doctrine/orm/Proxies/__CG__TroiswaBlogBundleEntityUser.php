 ...
 */
class User extends \Troiswa\BlogBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Troiswa\\BlogBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'Troiswa\\BlogBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'Troiswa\\BlogBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'Troiswa\\BlogBundle\\Entity\\User' . "\0" . 'salt');
        }
